...
def prepro_captions(imgs):
    ...
    #print len(imgs),type(imgs)   #239969， list
    #print imgs   
    #print imgs.keys()
    ...
    for i, img in enumerate(imgs):
        ...
        #print i,img
        #print img.keys()
        img['processed_tokens'] = []   #filename, sentences, split, cocoid, filepath, 又加了一个processed_tokens
        #for each image 
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='/data/liyuntao/DataSet/coco_ai_challenger.json',
                        help='input json file to process into hdf5')
    parser.add_argument('--num_val', default=30000, type=int,
                        help='number of images to assign to validation data (for CV etc)')
    parser.add_argument('--output_json', default='/data/liyuntao/DataSet/coco_ai_challenger_talk.json', help='output json file')
    parser.add_argument('--output_h5', default='/data/liyuntao/DataSet/coco_ai_challenger_talk_v2', help='output h5 file')

    # options
    parser.add_argument('--max_length', default=32, type=int,
                        help='max length of a caption, in number of words. captions longer than this get clipped.')
    parser.add_argument('--images_root', default='/data/liyuntao/DataSet',
